...
export type SchemaMatchesType = [
  ...
  Expect<Same<Parsed<typeof ViewAllLinkSchema>, ViewAllLink>>,
  ...
  Expect<Same<Parsed<typeof ReviewsHighlightSectionSchema>, ReviewsHighlightSection>>,
  Expect<Same<Parsed<typeof SplitBannerSectionSchema>, SplitBannerSection>>,
  Expect<Same<Parsed<typeof UGCTileSchema>, UGCTile>>,
  Expect<Same<Parsed<typeof UGCGridSectionSchema>, UGCGridSection>>,
  Expect<Same<Parsed<typeof NewsletterSectionSchema>, NewsletterSection>>,
  Expect<Same<Parsed<typeof HomeSectionSchema>, HomeSection>>,
